import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { inject, computed, useModel, unref, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, createTextVNode, toDisplayString, createCommentVNode, mergeModels, defineComponent, provide, toRef, getCurrentInstance, toHandlerKey, camelize, ref, h, Teleport, hasInjectionContext, useSlots, toValue, resolveDynamicComponent, watch, toRefs, isRef, Comment, cloneVNode, onServerPrefetch, shallowRef, resolveComponent, nextTick, useId, watchEffect, markRaw, Fragment, customRef, renderList, useTemplateRef, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle, shallowReactive, reactive, createElementBlock, onScopeDispose, defineAsyncComponent, useSSRContext, Suspense, createApp, onErrorCaptured, effectScope, getCurrentScope, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { s as serialize, l as defu, m as hasProtocol, n as klona, o as isScriptProtocol, j as joinURL, q as isEqual, r as parseQuery, t as defuFn, w as withQuery, v as sanitizeStatusCode, x as parseURL, e as encodePath, y as decodePath, z as getRequestHeader, A as getContext, B as setCookie, C as getCookie, D as deleteCookie, f as createError$1, E as withTrailingSlash, F as withoutTrailingSlash, $ as $fetch$1, G as baseURL, H as executeAsync } from '../nitro/nitro.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import colors from 'tailwindcss/colors';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderVNode, ssrRenderList, ssrRenderStyle, ssrRenderSuspense } from 'vue/server-renderer';
import { unrefElement, reactiveOmit, reactivePick, useMounted, useDebounceFn, defaultWindow, createSharedComposable, onKeyStroke, useVModel, useRafFn } from '@vueuse/core';
...
const _routes = [
  {
    ...
    component: () => import('./bookings-C42g_AuN.mjs')
  },
  {
    name: "admin-rooms",
    path: "/admin/rooms",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": "admin" } },
    component: () => import('./rooms-stPXrDHj.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import('./login-BTD85TOn.mjs')
  },
  {
    name: "auth-register",
    path: "/auth/register",
    component: () => import('./register-CfzQn1HF.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": "admin" } },
    component: () => import('./index-Brdm41nv.mjs')
  },
  {
    name: "bookings",
    path: "/bookings",
    meta: { "middleware": "auth" },
    component: () => import('./bookings-l6ZJKK9B.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-Dji5wY_z.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-B0vvXXET.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-Gxew2yMi.mjs'),
  auth: () => import('./auth-C2_PgW8i.mjs')
};
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-DddUU59q.mjs').then((m) => m.default || m))
};
...
const useAuth = () => {
  ...
  return {
    ...
    isAdmin,
    initAuth,
    // Обязательно возвращаем функцию наружу!
    fetchCurrentUser: initAuth,
    // Для middleware/admin.ts
    login,
    register,
    logout,
    getAuthHeaders
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B0PEL07t.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-ByMKVAEo.mjs'));
...
export { useRequestFetch as $, usePortal as A, isArrayOfArray as B, get as C, _sfc_main$c as D, getDisplayValue as E, FieldGroupReset as F, useLocale as G, useEmitAsProps as H, usePrimitiveElement as I, _sfc_main$9 as J, pickLinkProps as K, _sfc_main$a as L, omit as M, AUTOFOCUS_ON_MOUNT as N, focusFirst as O, Primitive as P, getTabbableCandidates as Q, focus as R, AUTOFOCUS_ON_UNMOUNT as S, Teleport_default as T, EVENT_OPTIONS as U, VisuallyHidden_default as V, getTabbableEdges as W, defineKeyedFunctionFactory as X, fetchDefaults as Y, useAsyncData as Z, __nuxt_component_0$1 as _, useSeoMeta as a, formErrorsInjectionKey as a0, formInputsInjectionKey as a1, inputIdInjectionKey as a2, formFieldInjectionKey as a3, formBusInjectionKey as a4, formStateInjectionKey as a5, formLoadingInjectionKey as a6, formOptionsInjectionKey as a7, defineNuxtRouteMiddleware as a8, useRoute as a9, useAuth as b, useToast as c, _sfc_main$8 as d, entry_default as default, useRuntimeConfig as e, useComponentProps as f, useAppConfig as g, useFormField as h, useComponentIcons as i, _sfc_main$d as j, _sfc_main$b as k, looseToNumber as l, useFieldGroup as m, navigateTo as n, __nuxt_component_0 as o, injectConfigProviderContext as p, isNullish as q, useCollection as r, createContext as s, tv as t, useHead as u, useForwardProps$1 as v, useForwardExpose as w, Presence_default as x, getActiveElement as y, useForwardProps as z };
